...
var gallerySet = new Class({
	...
	changeGallery: function(number)
	{
		...
		this.gallerySelectorBtn.set('html', 'Back to Galleries ');
		//this.gallerySelectorBtn.set('html', 'Back to Galleries > ' + this.gallerySet[number].title);
	...
	createGalleryButtons: function () {
		...
		this.gallerySet.each(function(galleryItem, index){
			...
			new Element('h3').addClass('info').set('html', galleryItem.title).injectInside(button);
